...
import { Code2, Zap, Target, Heart, BookOpen, Microscope } from 'lucide-react'

const About: React.FC = () => {
  const skills = [
    'JavaScript', 'TypeScript', 'Python', 'React', 'Node.js', 
    'Mathematical Analysis', 'Data Science', 'Machine Learning', 'System Design'
  ]
  ...
  const highlights = [
    ...
    { icon: BookOpen, label: 'Mathematical Analysis', description: 'Research in advanced mathematics' },
    { icon: Microscope, label: 'Data Science Research', description: 'Innovative data-driven solutions' }
  ]
            ...
            <motion.div variants={itemVariants} className="space-y-8">
              <Card className="glass-strong hover-lift border-white/10">
                <CardContent className="p-8">
                  <motion.p 
                    className="text-lg text-muted-foreground mb-6 leading-relaxed text-body"
                    variants={itemVariants}
                  >
                  ...
                  <motion.p 
                    ...
                    variants={itemVariants}
                  >
                    I completed my B.Tech in Computer Science from <span className="text-primary font-semibold">NSUT Delhi</span> with 
                    a CGPA of <span className="text-primary font-semibold">8.0</span>, where I conducted research in 
                    <span className="text-primary font-semibold"> Mathematical Analysis</span> and 
                    <span className="text-primary font-semibold"> Data Science</span>.
                  </motion.p>
                  
                  <motion.p 
                    className="text-lg text-muted-foreground mb-8 leading-relaxed text-body"
                    variants={itemVariants}
                  >
                    My journey began at <span className="text-primary font-semibold">Delhi Public School</span>, where I was 
                    always curious about development and technology. Beyond coding, I'm an avid chess player and love singing. 
                    I believe in the power of technology to solve real-world problems and create meaningful impact.
                  </motion.p>

                  <motion.div variants={itemVariants}>
                    <h3 className="text-xl font-semibold mb-6 text-foreground flex items-center gap-2 text-display">
                    ...
                    <div className="flex flex-wrap gap-3">
                      {skills.map((skill, index) => (
                        ...
                        >
                          <Badge 
                            variant="secondary" 
                            className="text-sm px-4 py-2 bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all duration-300 shimmer text-body"
                          >
                            {skill}
                          </Badge>
                        </motion.div>
                  ...
                  >
                    <Card className="glass hover-glow border-white/5 h-full">
                      <CardContent className="p-6 text-center">
                        ...
                        <h4 className="font-semibold text-foreground mb-2 text-sm text-display">
                          {highlight.label}
                        </h4>
